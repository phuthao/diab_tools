...
CREATE TABLE `districts` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `ix_districts_code` (`code`),
  KEY `ix_districts_create_datetime` (`create_datetime`),
  KEY `ix_districts_creator_id` (`creator_id`),
  KEY `ix_districts_is_deleted` (`is_deleted`),
  KEY `ix_districts_province_id` (`province_id`),
  KEY `ix_districts_update_datetime` (`update_datetime`),
  KEY `ix_districts_updater_id` (`updater_id`),
